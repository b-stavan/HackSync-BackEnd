...
using HackSyncAPI.Repositories;
...
namespace HackSyncAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "HackSyncAPI", Version = "v1" });
            });
           ...
           context.UseSqlServer(Configuration.GetConnectionString("DefaultConnection")));
            ...
            services.AddScoped(typeof(ITeamMemberRepositories), typeof(TeamMemberRepositories));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "HackSyncAPI v1"));
            }
